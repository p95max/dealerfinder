...
`DealerFinder` — server-rendered Django-приложение для поиска автодилеров в Германии. Веб-система для поиска,
фильтрации и структурированного подбора сервисных организаций с использованием внешнего геоданных-провайдера и механизмов ограничения API-потребления.
