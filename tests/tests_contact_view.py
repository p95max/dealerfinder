...
class ContactViewTests:
    ...
    def test_contact_view_invalid_turnstile_returns_warning_and_does_not_save(self, client, mocker):
        mocked_verify = mocker.patch(
            "apps.dealers.views.verify_turnstile",
            return_value=False,
        )
        ...
        response = client.post(
            ...
            data={
                ...
                "email": "max@example.com",
                "message": "Hello from test",
                "cf-turnstile-response": "token-bad",
            },
            REMOTE_ADDR="127.0.0.1",
            follow=True,
        )
        ...
        mocked_verify.assert_called_once_with("token-bad", "127.0.0.1")